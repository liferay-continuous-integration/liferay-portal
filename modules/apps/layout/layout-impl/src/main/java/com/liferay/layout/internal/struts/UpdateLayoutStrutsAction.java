...
public class UpdateLayoutStrutsAction implements StrutsAction {
	...
	protected void activate(BundleContext bundleContext) {
		_serviceTrackerMap = ServiceTrackerMapFactory.openSingleValueMap(
			bundleContext, UpdatePortletPreferencesContributor.class,
			"model.class.name");
	}
	...
	protected void storeAddContentPortletPreferences(
		...
		UpdatePortletPreferencesContributor
			updatePortletPreferencesContributor = _serviceTrackerMap.getService(
				className);

		if (updatePortletPreferencesContributor == null) {
			updatePortletPreferencesContributor = _serviceTrackerMap.getService(
				AssetEntry.class.getName());
		}

		if (updatePortletPreferencesContributor != null) {
			updatePortletPreferencesContributor.updatePortletPreferences(
	...
	private ServiceTrackerMap<String, UpdatePortletPreferencesContributor>
		_serviceTrackerMap;
