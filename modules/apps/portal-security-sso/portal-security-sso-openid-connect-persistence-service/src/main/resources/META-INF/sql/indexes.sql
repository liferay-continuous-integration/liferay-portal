...
create index IX_B1915EA3 on OpenIdConnectSession (companyId, issuer[$COLUMN_LENGTH:256$], sessionId[$COLUMN_LENGTH:75$]);
...
create unique index IX_C1F8E7E on OpenIdConnectSession (userId, issuer[$COLUMN_LENGTH:256$]);

create unique index IX_2B0E351D on OpenIdConnectUser (companyId, issuer[$COLUMN_LENGTH:256$], subject[$COLUMN_LENGTH:75$]);
