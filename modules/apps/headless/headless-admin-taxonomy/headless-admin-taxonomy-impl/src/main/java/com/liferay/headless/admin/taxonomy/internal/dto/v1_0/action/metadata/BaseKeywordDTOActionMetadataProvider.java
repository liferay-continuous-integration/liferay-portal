...
public abstract class BaseKeywordDTOActionMetadataProvider {
	...
	public BaseKeywordDTOActionMetadataProvider() {
		_actionInfoMap.put(
			"delete",
			new ActionInfo(
				getDeleteActionKey(), KeywordResourceImpl.class,
				getDeleteResourceMethodName()));
		_actionInfoMap.put(
			"get",
			new ActionInfo(
				getGetActionKey(), KeywordResourceImpl.class,
				getGetResourceMethodName()));
		_actionInfoMap.put(
			"replace",
			new ActionInfo(
				getReplaceActionKey(), KeywordResourceImpl.class,
				getReplaceResourceMethodName()));
		_actionInfoMap.put(
			"update",
			new ActionInfo(
				getUpdateActionKey(), KeywordResourceImpl.class,
