...
public abstract class BaseTaxonomyVocabularyDTOActionMetadataProvider {
	...
	public BaseTaxonomyVocabularyDTOActionMetadataProvider() {
		_actionInfoMap.put(
			"delete",
			new ActionInfo(
				getDeleteActionKey(), TaxonomyVocabularyResourceImpl.class,
				getDeleteResourceMethodName()));
		_actionInfoMap.put(
			"get",
			new ActionInfo(
				getGetActionKey(), TaxonomyVocabularyResourceImpl.class,
				getGetResourceMethodName()));
		_actionInfoMap.put(
			"replace",
			new ActionInfo(
				getReplaceActionKey(), TaxonomyVocabularyResourceImpl.class,
				getReplaceResourceMethodName()));
		_actionInfoMap.put(
			"update",
			new ActionInfo(
				getUpdateActionKey(), TaxonomyVocabularyResourceImpl.class,
