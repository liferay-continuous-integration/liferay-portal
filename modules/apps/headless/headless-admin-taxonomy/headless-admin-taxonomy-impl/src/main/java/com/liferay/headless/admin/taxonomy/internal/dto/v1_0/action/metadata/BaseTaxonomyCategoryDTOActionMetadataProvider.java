...
public abstract class BaseTaxonomyCategoryDTOActionMetadataProvider {
	...
	public BaseTaxonomyCategoryDTOActionMetadataProvider() {
		_actionInfoMap.put(
			"delete",
			new ActionInfo(
				getDeleteActionKey(), TaxonomyCategoryResourceImpl.class,
				getDeleteResourceMethodName()));
		_actionInfoMap.put(
			"get",
			new ActionInfo(
				getGetActionKey(), TaxonomyCategoryResourceImpl.class,
				getGetResourceMethodName()));
		_actionInfoMap.put(
			"replace",
			new ActionInfo(
				getReplaceActionKey(), TaxonomyCategoryResourceImpl.class,
				getReplaceResourceMethodName()));
		_actionInfoMap.put(
			"update",
			new ActionInfo(
				getUpdateActionKey(), TaxonomyCategoryResourceImpl.class,
