 ...
 */
@Generated("")
@GraphQLName(description = "A portal instance.", value = "PortalInstance")
@io.swagger.v3.oas.annotations.media.Schema(description = "A portal instance.")
...
public class PortalInstance implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.portal.instances.dto.v2_0.PortalInstance",
		name = "x-class-name"
	)
