 ...
 */
@Component(
	property = "resource.locator.key=/headless-portal-instances/v2.0/PortalInstance",
	...
	public PortalInstanceResource.Builder create() {
		return new PortalInstanceResource.Builder() {
			...
			public PortalInstanceResource build() {
				...
				Function<InvocationHandler, PortalInstanceResource>
					portalInstanceResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_portalInstanceResourceProxyProviderFunction;

				return portalInstanceResourceProxyProviderFunction.apply(
			...
			@Override
			public PortalInstanceResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
...
// LIFERAY-REST-BUILDER-HASH:-1831160562