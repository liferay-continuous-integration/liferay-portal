...
public class ObjectArrayPropertyTestEntityTest {
	...
	public void testToJSON() throws Exception {
		...
		objectArrayPropertyTestEntity.setObjectArrayProperty(_MIXED_ELEMENTS);

		JSONAssert.assertEquals(
			_MIXED_ELEMENTS_JSON,
	...
	public void testToString() throws Exception {
		...
		JSONAssert.assertEquals(
			_MIXED_ELEMENTS_JSON, objectArrayPropertyTestEntity.toString(),
			true);
	}

	private static final Object[] _MIXED_ELEMENTS = {
		Collections.singletonMap("key", "value"), Arrays.asList("a", "b"),
		"quoted \"string\"", 1, true
	};

	private static final String _MIXED_ELEMENTS_JSON =
