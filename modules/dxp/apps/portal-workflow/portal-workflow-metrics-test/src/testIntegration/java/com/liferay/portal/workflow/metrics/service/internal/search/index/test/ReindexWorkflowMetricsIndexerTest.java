...
public class ReindexWorkflowMetricsIndexerTest
	...
	public void testReindexPopulatesDocuments() throws Exception {
		...
		long processId = kaleoTaskInstanceToken.getKaleoDefinitionId();
		long taskId = kaleoTaskInstanceToken.getKaleoTaskInstanceTokenId();

		_assertInstanceReindexPopulatesDocuments(
			processId, taskId, IndexReindexer.ExecutionMode.FULL);
		_assertInstanceReindexPopulatesDocuments(
			processId, taskId, IndexReindexer.ExecutionMode.SYNC);

		_assertTaskReindexPopulatesTemplates(
			processId, IndexReindexer.ExecutionMode.FULL);
		_assertTaskReindexPopulatesTemplates(
			processId, IndexReindexer.ExecutionMode.SYNC);
	}
	...
	private void _assertInstanceReindexPopulatesDocuments(
		...
		Query taskTemplateQuery = _getTemplateQuery("taskId", processId);
		...
		Query tasksQuery = _getTasksQuery(taskId);
	...
	private void _assertTaskReindexPopulatesTemplates(
			long processId, IndexReindexer.ExecutionMode executionMode)
		throws Exception {
